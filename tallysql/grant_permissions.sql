REVOKE ALL ON SCHEMA public FROM tally_ds, tally_web, tally_job;
...
ALTER USER tally_job NOCREATEDB;

GRANT USAGE ON SCHEMA tallyds, tallyweb, tallyjob, lab, django TO tally_ds;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES 
	IN SCHEMA tallyds, tallyweb, tallyjob, lab, django TO tally_ds;
